...
Uses doubao in JSON mode. Output schema:
{
  ...
  "tools": [
     {"tool": "market_cn.index", "args": {"symbols": ["000300","000905"], "years": 20}},
     {"tool": "market_cn.stock", "args": {"symbol": "600519", "lookback_days": 365}},
     {"tool": "financials",      "args": {"symbol": "600519", "kinds": ["income","balance","cashflow"]}},
     {"tool": "filings",         "args": {"symbol": "600519", "years_back": 2}},
     {"tool": "web",             "args": {"queries": ["贵州茅台 竞争 风险"]}}
  ],
...
SYSTEM = """You are the planning module of a Chinese A-share personal finance agent.
